...
import '../widgets/az_lsit_view_container.dart';
      ...
      child: InkWell(
        ...
        child: Row(
          ...
          children: [
            ...
            SvgPicture.asset(
              'assets/ui_plugins_images/ic_right_arrow.svg',
            ...
            return InkWell(
              onTap: () {
                ...
                if (!handle) {
                  ...
                  // }));
                  Navigator.push(context,MaterialPageRoute(builder: (context) => OthersProfilePage(user_id: showItem.user.userId!)));
                }
              },
