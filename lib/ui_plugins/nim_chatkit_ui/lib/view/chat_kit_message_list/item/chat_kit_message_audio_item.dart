...
class ChatKitMessageAudioState extends State<ChatKitMessageAudioItem>
  ...
  final List<String> toAniList = [
    'assets/ui_plugins_images/ic_sound_to_1.svg',
    'assets/ui_plugins_images/ic_sound_to_2.svg',
    'assets/ui_plugins_images/ic_sound_to_3.svg'
  ];

  final List<String> fromAniList = [
    'assets/ui_plugins_images/ic_sound_from_1.svg',
    'assets/ui_plugins_images/ic_sound_from_2.svg',
    'assets/ui_plugins_images/ic_sound_from_3.svg'
  ];
