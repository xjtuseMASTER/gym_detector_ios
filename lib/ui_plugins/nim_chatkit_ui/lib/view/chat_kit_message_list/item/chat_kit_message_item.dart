...
import '../../../view/chat_kit_message_list/pop_menu/chat_kit_message_pop_menu.dart';
import '../../../view/chat_kit_message_list/pop_menu/chat_kit_pop_actions.dart';
import '../../../view/page/chat_message_ack_page.dart';
  ...
  Widget _getMessageStatus(ChatMessage message) {
    if (message.nimMessage.status == NIMMessageStatus.sending &&
      ...
      return GestureDetector(
        ...
        child: SvgPicture.asset('assets/ui_plugins_images/ic_failed.svg',
              width: 16, height: 16),
      );
      ...
      return InkWell(
        ...
        child: ProgressRing(
          ...
          startImage:
              SvgPicture.asset('assets/ui_plugins_images/ic_unread.svg',  ),
          finishImage:
              SvgPicture.asset('assets/ui_plugins_images/ic_read.svg',  ),
        ),
      );
    } else {
      return Container();
                                          ...
                                          builder: (context, snapshot) {
                                            return Container(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    SvgPicture.asset(
                                                        'assets/ui_plugins_images/ic_message_pin.svg',
                                                         ),
                                                    _getPinText(
                                                        _getPintContent(
                                                            snapshot.data),
