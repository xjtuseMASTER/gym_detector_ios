...
class ChatKitMessageFileState extends State<ChatKitMessageFileItem> {
  ...
  String _getIcon() {
    ...
    return "assets/ui_plugins_images/$fileType";
  }
  ...
  bool _needAudioFocus() {
    ...
    return icon == 'assets/ui_plugins_images/ic_file_video.svg' ||
        icon == 'assets/ui_plugins_images/ic_file_audio.svg';
  }
        ...
        ? [
            ...
            Positioned(
              ...
              child: SvgPicture.asset(
                "assets/ui_plugins_images/ic_video_pause.svg",
