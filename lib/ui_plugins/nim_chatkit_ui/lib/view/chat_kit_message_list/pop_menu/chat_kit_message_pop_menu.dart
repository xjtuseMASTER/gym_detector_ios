    ...
    final firstRowList = [
      ...
      if (config?.popMenuConfig?.enablePin != false && _enableStatus(message))
        {
          ...
          "icon": "assets/ui_plugins_images/ic_chat_pin.svg"
        },
      ...
      if (shouldShowRevokeAction &&
          ...
          _enableStatus(message))
        {
          ...
          "id": revokeMessageId,
          "icon": "assets/ui_plugins_images/ic_chat_revoke.svg"
        }
    ];
    return firstRowList
        .map(
