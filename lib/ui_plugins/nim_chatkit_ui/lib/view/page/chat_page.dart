...
import '../../view/chat_kit_message_list/chat_kit_message_list.dart';
...
class ChatPageState extends BaseState<ChatPage> with RouteAware {
  ...
  void _defaultAvatarTap(String? userId, {bool isSelf = false}) {
    if (isSelf) {
      ...
      Navigator.push(context,MaterialPageRoute(builder: (context) => OthersProfilePage(user_id: userId!)));
    }
  }
                      ...
                      context.watch<ChatViewModel>().isMultiSelected
                          ...
                          : IconButton(
                              ...
                              icon: SvgPicture.asset(
                                'assets/ui_plugins_images/ic_setting.svg',
                                width: 26,
                                height: 26,
                                ...
                                children: [
                                  BottomOption(
                                    icon: haveSelectedMessage
                                        ? 'assets/ui_plugins_images/ic_chat_merge_forward.svg'
                                        : 'assets/ui_plugins_images/ic_chat_merge_forward_disable.svg',
                                    label:
                                  ...
                                  BottomOption(
                                    icon: haveSelectedMessage
                                        ? 'assets/ui_plugins_images/ic_chat_item_forward.svg'
                                        : 'assets/ui_plugins_images/ic_chat_item_forward_disable.svg',
                                    label:
                                  ...
                                  BottomOption(
                                    icon: haveSelectedMessage
                                        ? 'assets/ui_plugins_images/ic_chat_delete_round.svg'
                                        : 'assets/ui_plugins_images/ic_chat_delete_round_disable.svg',
                                    label:
