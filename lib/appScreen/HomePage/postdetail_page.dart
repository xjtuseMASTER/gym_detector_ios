...
class _DetailPageState extends State<DetailPage> {
  ...
  Future<void> operateFavorite(String post_id)async {
    ...
    final response = await customHttpClient.get(
        Uri.parse(isFavorite?'http://127.0.0.1:4523/m1/5245288-4913049-default/post_like/unlike':'http://127.0.0.1:4523/m2/5245288-4913049-default/222467509').replace(
          queryParameters: {
  ...
  Future<void> operateCollect(String post_id)async {
    ...
    // 发送请求
    final response = await customHttpClient.get(
        Uri.parse(isCollect?'http://127.0.0.1:4523/m1/5245288-4913049-default/post_collect/uncollect':'http://127.0.0.1:4523/m1/5245288-4913049-default/post_collect/collect?apifoxApiId=222461490').replace(
          queryParameters: {
            'user_id': GlobalUser().user!.user_id, // 传入 user_id 参数
            'post_id': post_id
          },
  ...
  Future<Map<String, dynamic>> fetchPostData() async {
    try {
      final response = await customHttpClient.get(
        Uri.parse('http://127.0.0.1:4523/m1/5245288-4913049-default/post/details').replace(
  ...
  try {
    final response = await customHttpClient.get(
      Uri.parse('http://127.0.0.1:4523/m1/5245288-4913049-default/comment/commentdetail').replace(
        queryParameters: {'post_id': widget.postId},
      ),
    );
    ...
    if (response.statusCode == 200) {
      final jsonResponse = json.decode(response.body);
      isExpandedList = List<bool>.filled(jsonResponse['data']['commentList'].length ,false,growable: true);
      return List<Map<String, dynamic>>.from(jsonResponse['data']['commentList'] ?? []);
    } else {
      print('Failed to fetch Comment data with status code: ${response.statusCode}');
      return [];
    }
  } catch (e) {
...
Future<void> replyToPost(Map<String,dynamic> body) async{
  ...
  try {
    ...
    final response = await customHttpClient.post(
      Uri.parse('http://127.0.0.1:4523/m1/5245288-4913049-default/comment/comment'),
...
Future<void> replyToComment(Map<String,dynamic> body) async{
  ...
  try {
    ...
    // 发送 POST 请求到后端
    final response = await customHttpClient.post(
      Uri.parse('http://127.0.0.1:4523/m1/5245288-4913049-default/comment/sub_comment'),
      body: jsonEncode(body),
    );
    if (response.statusCode == 200) {
          CustomSnackBar.showSuccess(context, "reply successfully!");
                  ...
                  children: [
                    GestureDetector(
                      onTap: () {
                        ...
                        MaterialPageRoute(
                          builder:  (context)=>OthersProfilePage(user_id: post['authorId'])
                        )
                        );
                      },
                      child:  CircleAvatar(
                      backgroundImage: post['authorAvatar'] == ''
                                    ...
                                    : NetworkImage(post['authorAvatar']) as ImageProvider, // 帖子作者头像
                      radius: 20,
                    ),
                    ),
                    SizedBox(width: 10),
                    ...
                    child: Stack(
                      children: [
                        ...
                        Positioned(
                          ...
                          child: Row(
                            children: List.generate(post['picList'].length, (index) {
                              return Container(
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Row(
                                  ...
                                  builder: (context, double scale, child) {
                                    return Transform.scale(
                                      ...
                                      child: IconButton(
                                        ...
                                        onPressed: () async  {
                                          await operateFavorite(post['postId']);
                                ...
                                Text(isFavorite?quantityCarry(post['likesNum']+1):quantityCarry(post['likesNum'])),
                                ],
                              ),
                              SizedBox(width: 5),
                              //收藏图表和收藏数
                              Row(
                                  ...
                                  builder: (context, double scale, child) {
                                    return Transform.scale(
                                      ...
                                      child: IconButton(
                                        ...
                                        onPressed: ()async {
                                          //上传后端处理逻辑
                                          await operateCollect(post['postId']);
                                          setState(() {
                                ...
                                Text(isCollect?quantityCarry(post['collectsNum']+1):quantityCarry(post['collectsNum'])),
                                ],
                              ),
                              SizedBox(width: 5),
                              //评论图表和评论数
                                ...
                                children: [
                                  ...
                                  onPressed: () {
                                    ...
                                    final   body={
                                      ...
                                      _showReplyInput(context, body,true,-1,"");
                                  },
                                ),
                                    ...
                                    return Column(
                                      ...
                                      children: [
                                                ...
                                                children: [
                                                  TextButton(
                                                   ...
                                                   final body={
                                                                      ...
                                                                      "fatherCommentId":  comment['commentId'],
                                                                      "content": ""
                                                                  };
                                                                  _showReplyInput(context,body,false,index,comment['authorName']);
                                        ...
                                        if (isExpandedList[index])
                                          Padding(
                                            padding: const EdgeInsets.only(left: 30.0), // 适度缩进
                                                      ...
                                                      leading:GestureDetector( 
                                                        onTap: () {
                                                           Navigator.push(
                                                                context,
                                                                MaterialPageRoute(
                                                                  builder: (context) => OthersProfilePage(user_id: reply['authorId']),
                                                                ),
                                                              );
                                                        },   
                                                        child:CircleAvatar(
                                                              ...
                                                              TextButton(
                                                                onPressed: () {
                                                                  final body={
                                                                      ...
                                                                      "postId": widget.postId,
                                                                      "rootCommentId": comment['commentId'],
                                                                      "fatherCommentId": reply['commentId'],
                                                                      "content": ""
                                                                  };
                                                                  _showReplyInput(context,body,false,index,reply['authorName']);
                                                                },
                                                                child: Text('reply'),
                                                              ),
                                                            ],
  ...
  void _showReplyInput(BuildContext context,Map<String,dynamic> body,bool isComment,int index,String replyTo) { //isComment 代表是否是直接对帖子的评论  index：对应第几条评论，如果是直接对帖子评论的就传-1
                  ...
                  ElevatedButton(
                    onPressed: () {
                      if (replyController.text.isNotEmpty) {
                        ...
                        if (isComment) {
                          setState(() {
                            commentlist.insert(0, generateComment(replyController.text));
                          ...
                          setState(() {
                            commentlist[index]['replies'].insert(0, generateReply(replyController.text, replyTo));
                          });
                        ...
                        setModalState(() => errorMessage = 'Please input first！');
                      }
                    },
                    child: Text('Send'),
                  ),
